...
namespace Tavisca.Libraries.Logging.Tests.Filters
{
    ...
    public class FilterImplementationTest
    {
        ...
        [TestMethod]
        public void Should_Filter_AwsArn1()
        {
            string awsArn = "arn:aws:kms:us-east-1:123456789012:key";
            var id = Convert.ToString(Guid.NewGuid());
            var apiLog = Utility.GetApiLog();
            apiLog.Id = id;
            apiLog.SetValue("AwsKey", awsArn);
        ...
        [TestMethod]
        public void Should_Filter_AwsArn2()
        {
            string awsArn = "arn:aws:ec2:us-west-2:123456789012:vpc/vpc";
            var id = Convert.ToString(Guid.NewGuid());
            var apiLog = Utility.GetApiLog();
            apiLog.Id = id;
            apiLog.SetValue("AwsKey", awsArn);
        ...
        [TestMethod]
        public void Should_Filter_AwsArn3()
        {
            string awsArn = "arn:aws:kafka:us-east-1:123456789012:cluster/example-cluster-name/0203456a-abcd-1234-cdef-3be56f8c54ce-2";
            var id = Convert.ToString(Guid.NewGuid());
            var apiLog = Utility.GetApiLog();
        ...
        [TestMethod]
        public void Should_Filter_AwsArn4()
        {
            string awsArn = "arn:aws:ec2:us-west-2:123456789012:vpc:vpc";
            var id = Convert.ToString(Guid.NewGuid());
            var apiLog = Utility.GetApiLog();
